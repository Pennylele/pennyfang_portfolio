"""
Django settings for pf_portfolio project.
...
ALLOWED_HOSTS = ['167.71.161.121', '127.0.0.1', 'localhost', 'www.pennyfang.com', 'pennyfang.com', '3.19.141.44']
# ALLOWED_HOSTS = ['*']
